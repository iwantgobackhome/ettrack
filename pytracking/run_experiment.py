...
def run_experiment(experiment_module: str, experiment_name: str, debug=0, threads=0):
    ...
    # print(trackers[0].create_tracker(trackers[0].get_parameters()))
    # print(dataset[0])
...
#    run_experiment(args.experiment_module, args.experiment_name, args.debug, args.threads)
    run_experiment('myexperiments', 'et_tracker', 0, 0)


if __name__ == '__main__':
    freeze_support()
    main()
    # a = np.loadtxt(fname='C:\\Users\Home\Desktop\paper\ettrack\ettrack\dataset/OTB100/BlurCar1/groundtruth_rect.txt', dtype=np.float64, delimiter=',')
    # print(a)
