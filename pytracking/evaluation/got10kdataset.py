...
class GOT10KDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        ground_truth_rect_txt = open(str(anno_path), 'r')
        ground_truth_rect = ground_truth_rect_txt.read().split(',')
        ground_truth_rect = np.array([ground_truth_rect[0], ground_truth_rect[1], ground_truth_rect[2], ground_truth_rect[3][:-2]]).astype(np.float64)
